...
class LSTMClassifier(nn.Module):
    ...
    def forward(self, input_seq):
        ...
        #class_scores = (self.out(rnn_output[0]))
        return class_scores


if __name__ == '__main__':
    emotion_dict = {'anger ': 0, 'happy': 1, 'sadness': 2, 'fear': 3, 'surprise': 4, 'neutral': 5}
        ...
        with torch.no_grad():
            ...
            if performance['acc'] > best_acc:
                ...
                torch.save({
                    ...
                    }, 'E:\app_demo_text\bi_lstm-best_model.pth'.format(config['model_code']))

                with open('E:\app_demo_text\bi_lstm-best_performance.pkl'.format(config['model_code']), 'wb') as f:
